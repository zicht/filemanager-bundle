...
class OriginalNamingStrategyTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        // Arrange
        $namingStrategy = new OriginalNamingStrategy(OriginalNamingStrategy::LOWER_CASE);
    ...
    {
        // Arrange
        $namingStrategy = new OriginalNamingStrategy(OriginalNamingStrategy::PRESERVE_CASE);
